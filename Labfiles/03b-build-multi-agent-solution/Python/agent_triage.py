...
def main():
    """
    Main function to run the triage agent solution.
    This function sets up the agents and processes support tickets.
    """
    ...
    model_deployment = os.getenv("SA_MODEL_DEPLOYMENT_NAME")
    ...
    with agents_client:
        ...
        # Triage agent is taking in prompts from the user
        while True:
            ...
            if prompt.lower() == "quit":
                break
            if len(prompt) == 0:
                print("Please enter a support ticket description.")
                continue
        ...
        print("All agents deleted. Exiting.")
