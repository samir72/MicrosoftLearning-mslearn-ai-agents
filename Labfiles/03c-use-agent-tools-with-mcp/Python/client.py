...
def main():
    """
    Main function to run the MCP agent solution.
    This function sets up the agent and processes a run with MCP tools.
    """
    ...
    tooldef = toolset.get_definitions_and_resources()
    # MCP tool definitions
    print(f"MCP Tool Definitions: {tooldef}")
    ...
    with agents_client:
        ...
        print("Deleted agent")
        print("Exiting the MCP agent solution.")
