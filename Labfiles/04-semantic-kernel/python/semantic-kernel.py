...
async def main():
    ...
    user_prompt = f"Here is the expenses data in your file:\n\n{data}\n\nWhat would you like me to do with it?\n\n"
    ...
    async with (
        ...
        expenses_agent_def = await project_client.agents.create_agent(
            ...
            instructions="""You are an AI assistant for expense claim submission.
                            ...
                            Specifically, extract the expense items and amounts from the provided data, sort the items in a descending order, calculate the total amount, and format this information clearly in the email body with a professional tone.
